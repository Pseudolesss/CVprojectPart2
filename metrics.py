...
if __name__ == "__main__":
    gt = [[np.array([1, 3.5, 2, 2, 1], dtype=np.float32), np.array([4, 2.5, 2, 7, 1], dtype=np.float32), np.array([1, 3.5, 7, 2, 8], dtype=np.float32)]]
    dt = [[np.array([4, 5.5, 5, 2, 1], dtype=np.float32), np.array([8, 3.5, 15, 20, 1], dtype=np.float32), np.array([3.5, 5.5, 13, 2, 8], dtype=np.float32)]]
